...
# 각자의 해역에 배를 위치시키는 함수
def set_ship(index, sea): #배의 시작점, 각자의 해역 리스트
...
# computer_index = random.randrange(1,15,1) 
...
while True:
    ...
    if player_attack_index == computer_index : 
        print()
    ...
    # 2-4) 플레이어의 공격이 실패한 경우
        ...
        player_attacked[player_attack_index-1] = 'True' #공격지역 기록
    
    # 2-5) 컴퓨터의 공격 위치 지정
    computer_attack_index = random.randrange(1,15,1) #범위 지정 해줘야한다.
    ...
    print('==============================================================================')
    print(f'컴퓨터의 공격기록: {computer_attacked} ')
    print('==============================================================================')
    # 2-6) 컴퓨터의 공격이 성공한 경우

    if computer_attack_index == player_index : 
        print()
